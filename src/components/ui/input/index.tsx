...
const inputStyle = tva({
	base: 'border-background-300 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-tertiary-700 data-[focus=true]:hover:border-tertiary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center',
...
const inputFieldStyle = tva({
	base: 'flex-1 text-tertiary-950 py-0 px-3 placeholder:text-tertiary-300 h-full ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
